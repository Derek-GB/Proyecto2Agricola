    ...
    public static boolean validateFields(JComponent... components) {
        for (JComponent component : components) {
            if (component instanceof JTextField) {
                ...
                System.out.println("Validando JComboBox: " + comboBox.getSelectedItem());

                if (!comboBox.isEditable()) {
                    // Validación estándar para JComboBox no editable
                    ...
                    // Validación para JComboBox editable
                    Object selectedItem = comboBox.getSelectedItem();
                    if (selectedItem == null || selectedItem.toString().trim().isEmpty()) {
                        System.out.println("Entrada no válida en JComboBox editable: " + comboBox.getName());
                        return false;
                    }
                }
            }
