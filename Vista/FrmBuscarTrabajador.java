...
public class FrmBuscarTrabajador extends javax.swing.JDialog {
    ...
    private List<Trabajador> ents;
    private DefaultTableModel tableModel;
    private Vista observer;
    private TableRowSorter<TableModel> sorter;

    public void setEnts(List<Trabajador> ents) {
        this.ents = ents;
        ...
        ents.forEach(trabajador -> tableModel.addRow(
                new Object[]{
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Correo", "Telefono", "Puesto", "Horario", "Salario"
            }
        ) {
